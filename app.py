...
# 1. Page Configuration (Replaces root.geometry and root.title)
...
# 2. Control Panel (Replaces Tkinter Button and Slider)
...
if uploaded_file is not None:
    ...
    if st.button("Generate Matrix Transformations", type="primary"):
        with st.spinner("Crunching matrices..."):
            ...
            # --- LEFT WINDOW: Standard SVD Baseline ---
            ...
            # --- RIGHT WINDOW: Enhanced Studio Pipeline ---
            ...
            # --- UI DISPLAY (Replaces display_on_label) ---
